...
if(fwv==="4.80"){
	var toc_addr=0x6F5520,
	default_vsh_pub_toc=0x6ED574,
	vsh_opd_patch=0x96D5C,
	vsh_opd_addr=0x6EBB68,
	vsh_toc_addr_screenshot=0x72054C,
	vsh_ps3hen_key_toc=0x707314,
	toc_entry1_addr=0x6DA3D0,
	toc_entry2_addr=0x7255D8,
	toc_entry3_addr=0x6DA3C8,
	toc_entry4_addr=0x740000,
	toc_entry5_addr=0x6EB690,
	gadget1_addr=0x097604,
	gadget2_addr=0x609694,
	gadget3_addr=0x0D505C,
	gadget4_addr=0x229834,
	gadget5_addr=0x12BB1C,
	gadget6_addr=0x61528C,
	gadget7_addr=0x01FFD0,
	gadget8_addr=0x020000,
	gadget9_addr=0x029B08,
	gadget10_addr=0x62D5D4,
	gadget11_addr=0x59A09C,
	gadget12_addr=0x0C864C,
	gadget13_addr=0x48E594,
	gadget14_addr=0x48C78C,
	gadget15_addr=0x489C74,
	gadget_mod1_addr=0x60E588,
	gadget_mod2_addr=0x013B74,
	gadget_mod3_addr=0x0B8E00,
	gadget_mod4a_addr=0x0D9684,
	gadget_mod4b_addr=0x42C780,
	gadget_mod4c_addr=0x054AF0,
	gadget_mod5_addr=0x4238E4,
	gadget_mod6_addr=0x020C00,
	gadget_mod7_addr=0x01A6AC,
	gadget_mod8_addr=0x2BACB0,
	gadget_mod9_addr=0x010B20,
	gadget_mod10_addr=0x1C5794,
	gadget_mod11_addr=0x18B144,
	gadget_mod12_addr=0x6327AC,
	gadget_mod13_addr=0x336878,
	gadget_mod14_addr=0x632EB0,
	gadget_mod15_addr=0x39D040,
	gadget_mod16_addr=0x4F7318;}
if(fwv==="4.81"){
	var toc_addr=0x6F5520,
	default_vsh_pub_toc=0x6ED574,
	vsh_opd_patch=0x96D5C,
	vsh_opd_addr=0x6EBB38,
	vsh_toc_addr_screenshot=0x72014C,
	vsh_ps3hen_key_toc=0x70733C,
	toc_entry1_addr=0x6DA3D0,
	toc_entry2_addr=0x725608,
	toc_entry3_addr=0x6DA3C8,
	toc_entry4_addr=0x740000,
	toc_entry5_addr=0x6EB690,
	gadget1_addr=0x097604,
	gadget2_addr=0x6096A8,
	gadget3_addr=0x0D505C,
	gadget4_addr=0x229838,
	gadget5_addr=0x12BB1C,
	gadget6_addr=0x6152A0,
	gadget7_addr=0x01FFD0,
	gadget8_addr=0x020000,
	gadget9_addr=0x029B08,
	gadget10_addr=0x62D5E8,
	gadget11_addr=0x59A0AC,
	gadget12_addr=0x0C864C,
	gadget13_addr=0x48E5A0,
	gadget14_addr=0x48C79C,
	gadget15_addr=0x489C84,
	gadget_mod1_addr=0x60E59C,
	gadget_mod2_addr=0x013B74,
	gadget_mod3_addr=0x0B8E00,
	gadget_mod4a_addr=0x0D9684,
	...
	gadget_mod10_addr=0x1C5794,
	gadget_mod11_addr=0x18B144,
	gadget_mod12_addr=0x6327C0,
	gadget_mod13_addr=0x33686C,
	gadget_mod14_addr=0x632EC4,
...
if(fwv==="4.92"){
	...
	vsh_opd_patch=0x96D5C,
	vsh_opd_addr=0x6EBB70,
	vsh_toc_addr_screenshot=0x72091C,
	vsh_ps3hen_key_toc=0x707B0C,
	toc_entry1_addr=0x6DA3D0,
	toc_entry2_addr=0x725DD8,
	toc_entry3_addr=0x6DA3C8,
	toc_entry4_addr=0x7400F0,
	toc_entry5_addr=0x6EB6C8,
	gadget1_addr=0x097604,
	gadget2_addr=0x60A0DC,
	gadget3_addr=0x0D505C,
